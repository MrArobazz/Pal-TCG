...
public class Arena_3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.toolbar_arena3).setVisibility(View.GONE);
        random = new Random();
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override
            public void handleOnBackPressed() { showToast(Arena_3_Activity.this, getString(R.string.try_to_press_back_button),2500);}
        });
    ...
    private void getComponents() {
        arena = findViewById(R.id.constraintLayout_arena3);

        progressBar_bot = findViewById(R.id.progressBar_pv_bot_arene3);
        progressBar_player = findViewById(R.id.progressBar_pv_player_arene3);

        playerPokemonSprite = findViewById(R.id.webView_sprite_player_arena3);
        botPokemonSprite = findViewById(R.id.webView_sprite_bot_arene3);
        ...
        attacksChoice = findViewById(R.id.listView_attackChoice_arena3);

        player_hp = findViewById(R.id.textView_pv_player_arena3);
        bot_hp = findViewById(R.id.textView_pv_bot_arena3);

        playerActiveCard = findViewById(R.id.imageView_card_player_arena3);
        botActiveCard = findViewById(R.id.imageView_bot_arena3);

        pokemonsChoice = findViewById(R.id.spinner_pokeChoice_arene3);
    ...
    void beginBattleWith(int position) {
        ...
        attacksChoice.setVisibility(View.GONE);
        pokemonsChoice.setVisibility(View.GONE);
        findViewById(R.id.toolbar_arena3).setVisibility(View.VISIBLE);
        pokemonsChoice.setSelection(0);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (receiver.getPv() == 0) {
                    ...
                    showToast(Arena_3_Activity.this, toastText);
                    if (isPlayer) {
                        nb_attempts = 0;
                ...
                showToast(Arena_3_Activity.this, getString(R.string.end_of_turn));
            }
        });
